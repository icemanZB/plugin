...
(function ($) {
    $.fn.jChinaArea = function (o) {
        ...
        if (o.s3 == null || o.s3=='') {
            loc.FillOption(sCounty, '0,1,4845');
        }
        else {
...
var carea = function () {
    var area = {};
    area.items = {
        '0': { 1: '省', 22: '北京市', 33: '天津市', 44: '上海市', 66: '重庆市', 108: '河北省', 406: '山西省', 622: '内蒙古', 804: '辽宁省', 945: '吉林省', 1036: '黑龙江省', 1226: '江苏省', 1371: '浙江省', 1500: '安徽省', 1679: '福建省', 1812: '江西省', 1992: '山东省', 2197: '河南省', 2456: '湖北省', 2613: '湖南省', 2822: '广东省', 3015: '广西', 3201: '海南省', 3235: '四川省', 3561: '贵州省', 3728: '云南省', 3983: '西藏', 4136: '陕西省', 4334: '甘肃省', 4499: '青海省', 4588: '宁夏', 4624: '新疆',4802:'香港' ,4805:'澳门',4808:'台湾'},
        '0,1': { 4845: '市' },
        '0,1,4845': { 4846: '区县' },
        '0,22': { 2: '北京市' },
        '0,22,2': { 3: '东城区', 4: '西城区', 5: '崇文区', 6: '宣武区', 7: '朝阳区', 8: '丰台区', 9: '石景山区', 10: '海淀区', 11: '门头沟区', 12: '房山区', 13: '通州区', 14: '顺义区', 15: '昌平区', 16: '大兴区', 17: '怀柔区', 18: '平谷区', 19: '密云县', 20: '延庆县', 21: '延庆镇' },
        '0,33': { 23: '天津市' },
        '0,33,23': { 24: '和平区', 25: '河东区', 26: '河西区', 27: '南开区', 28: '河北区', 29: '红桥区', 30: '塘沽区', 31: '汉沽区', 32: '大港区', 33: '东丽区', 34: '西青区', 35: '津南区', 36: '北辰区', 37: '武清区', 38: '宝坻区', 39: '蓟县', 40: '宁河县', 41: '芦台镇', 42: '静海县', 43: '静海镇' },
        '0,44': { 45: '上海市' },
        ...
        '0,4802': { 4803: '香港特别行政区' },
        '0,4802,4803': { 4804: '香港市区内' },
        '0,4805': { 4806: '澳门特别行政区' },
        '0,4805,4806': { 4807: '澳门市区内' },
        '0,4808': { 4809: '台湾' },
        '0,4808,4809': { 4810: '台湾市区内' }

    };
    area.Find = function (id) {
        if (typeof (area.items[id]) == "undefined")
            return false;
        return area.items[id];
    };
    area.FillOption = function (el_id, loc_id, selectedText) {
        var el = el_id;
        var json = area.Find(loc_id);
        if (json) {
